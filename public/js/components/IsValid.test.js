...
describe('Fullname', () => {
    ...
    describe('Gauname netinkamas reiksmes', () => {
        test('string', () => {
            const [err, msg] = IsValid.fullname('');
            expect(err).toBe(true);
            expect(msg).toBe('Per trumpas tekstas, turi buti 5 simboliai maziausiai.');
        })
        ...
        test('single word', () => {
            ...
            expect(err).toBe(true);
            expect(msg).toBe('Teksta turi sudaryti 2 zodziai arba daugiau.');
        })
        ...
        test('one of words ir too short', () => {
            const [err, msg] = IsValid.fullname('Petras P');
            expect(err).toBe(true);
            expect(msg).toBe(`Visos vardo dalys turi buti maziausiai 2 simboliu.`);
        })

        test('few words ir too short', () => {
